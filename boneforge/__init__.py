"""BoneForge — Modular Blender Rigging Extension.

Blender add-on entry point. Reads ``bl_info`` for Blender's add-on
browser, registers an i18n layer, then walks every feature package in
...
bl_info = {
    ...
    "description": (
        "Universal rig UI, animation workflow, auto-rigging, mannequin "
        "generation, facial rig generation, and VRM/VRoid bridge for "
        "VTuber + VRChat pipelines"
    ),
    "category": "Rigging",
    "doc_url": "",
    "tracker_url": "",
...
def register():
    """Register BoneForge with Blender.
    ...
    """
    global _registered_manifest_ids
