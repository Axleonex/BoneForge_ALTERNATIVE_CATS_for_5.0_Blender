...
**バージョン 8.5.0 の新機能:** Open Blender 版は B4Artists 版とバージョン番号が揃いましたが、標準 Blender 用パッケージのままです。CATS/Material Combiner/UVToolkit ワークフロー向けの CATS Material Atlas UV バリエーション一式を含み、**Advanced Variation** と **Rotation Step** も使えます。ただし、B4Artists 専用の本番リギング、control picker、ホストロックアウト、Bforartists 固有コンテンツは含まれません。
