...
**주요 설정:**
- **Merge All Meshes** — 내보내기에서 하나의 메시로 결합합니다 (권장)
- **Apply Shape Keys to Basis** — 내보내기 전에 모든 활성 모양 키를 기본 메시 모양으로 병합합니다
- **Include Armature / Mesh / Materials / Animations** — 내보내기에 포함할 데이터를 토글합니다
...
**주요 설정:**
- **Model Name** — 아바타의 표시 이름
- **Author / License** — VRM 메타데이터에 저장된 생성자 정보
- **VRM Version** — 일반적으로 현재 앱의 1.0
...
**무엇을 하는지:** 장면을 VRM 내보내기 요구 사항에 대해 검증합니다 — 필수 휴머노이드 본, 메타데이터 완전성, 재료 설정을 확인합니다.

**Run VRM Lint**를 클릭하여 결과를 봅니다.
...
**대상 옵션:**
- **VRChat (Unity FBX)** — 표준 VRChat 내보내기
- **VRM** — VRM 내보내기로 위임합니다
- **MMD (PMX)** — MMD 내보내기로 위임합니다
- **Unreal Engine FBX** — Unreal 특정 설정과 LOD 지원이 있는 FBX
- **Unity General** — FBX + Unity 프로젝트용 메타데이터 사이드카

**일반적인 FBX 설정:**
- **Include Armature / Mesh / Materials / Animations** — 내보내기 구성 요소 토글
- **Bake Animation** — 호환성을 위해 제약 구동 애니메이션을 원본 키프레임으로 변환합니다
- **FBX Version** — ASCII 또는 Binary 형식
...
*BoneForge Documentation | 버전 8.3.1*
